...
public class CameraController : MonoBehaviour
{
  ...
  Vector3 GetWantedCameraPosition()
  {
    ...
    return _Target.position + MathUtil._2Dto3D(MathUtil.PositionInUnit(_RotationAngle * Mathf.Deg2Rad, _CurrentEntry._ForwardOffset), _CurrentEntry._HeightOffset);
  }
  ...
  void OnDrawGizmosSelected()
  {
    ...
    {
      Vector3 startingPosition = MathUtil._2Dto3D(MathUtil.PositionInUnit(_RotationAngle * Mathf.Deg2Rad, entry._ForwardOffset), entry._HeightOffset);
